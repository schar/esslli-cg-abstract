...
\section{Outline}
\begin{itemize}	
	\item Continuized CCGs generalize scope-taking (``ubiquitous scopal pied piping'') using three operations: \bsf{lift}, \bsf{triv}, and \bsf{scope}. %
	
	\item Main proposal: replacing \bsf{lift} and \bsf{triv} with options that countenance side effects (\citealt{Shan:2005}). Any side effects regime can be grafted onto a continuized CCG, by replacing \bsf{lift} and \bsf{triv} with monadic functors.%
